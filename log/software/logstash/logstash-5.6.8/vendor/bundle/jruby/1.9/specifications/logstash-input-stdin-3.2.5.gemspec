# -*- encoding: utf-8 -*-
# stub: logstash-input-stdin 3.2.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jruby-stdin-channel>, [">= 0"])
      s.add_development_dependency(%q<logstash-codec-plain>, [">= 0"])
      s.add_development_dependency(%q<logstash-codec-json>, [">= 0"])
      s.add_development_dependency(%q<logstash-codec-json_lines>, [">= 0"])
      ...
      s.add_dependency(%q<jruby-stdin-channel>, [">= 0"])
