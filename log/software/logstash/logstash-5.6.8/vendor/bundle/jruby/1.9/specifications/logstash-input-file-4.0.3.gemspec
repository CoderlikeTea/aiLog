# -*- encoding: utf-8 -*-
# stub: logstash-input-file 4.0.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<filewatch>, [">= 0.8.1", "~> 0.8"])
      s.add_runtime_dependency(%q<logstash-codec-multiline>, ["~> 3.0"])
      ...
      s.add_dependency(%q<filewatch>, [">= 0.8.1", "~> 0.8"])
      s.add_dependency(%q<logstash-codec-multiline>, ["~> 3.0"])
