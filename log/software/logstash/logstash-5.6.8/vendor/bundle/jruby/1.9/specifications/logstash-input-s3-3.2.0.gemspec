# -*- encoding: utf-8 -*-
# stub: logstash-input-s3 3.2.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<logstash-core-plugin-api>, ["<= 2.99", ">= 2.1.12"])
      ...
      s.add_dependency(%q<logstash-core-plugin-api>, ["<= 2.99", ">= 2.1.12"])
