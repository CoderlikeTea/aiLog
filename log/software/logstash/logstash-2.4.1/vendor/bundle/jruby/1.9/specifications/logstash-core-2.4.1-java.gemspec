# -*- encoding: utf-8 -*-
# stub: logstash-core 2.4.1 java lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<logstash-core-event>, ["= 2.4.1"])
      s.add_runtime_dependency(%q<cabin>, ["~> 0.8.0"])
      ...
      s.add_runtime_dependency(%q<jrjackson>, ["~> 0.3.7"])
    else
      s.add_dependency(%q<logstash-core-event>, ["= 2.4.1"])
      s.add_dependency(%q<cabin>, ["~> 0.8.0"])
      ...
      s.add_dependency(%q<jrjackson>, ["~> 0.3.7"])
    end
  else
    s.add_dependency(%q<logstash-core-event>, ["= 2.4.1"])
    s.add_dependency(%q<cabin>, ["~> 0.8.0"])
