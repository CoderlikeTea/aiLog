        ...
        if(oos != null) {
            try {
                if(this.ExtendPara!=null){
                    ...
                    Class getAttr = Class.forName(ExtendPara);
                    Object o = getAttr.newInstance();

                    Field[] fields = getAttr.getDeclaredFields();
                    ...
                    for(Field field:fields){
                        ...
                        Method method = getAttr.getMethod("get" + s);
